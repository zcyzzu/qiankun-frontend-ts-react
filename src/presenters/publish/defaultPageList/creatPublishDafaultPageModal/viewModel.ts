 ...
 * @LastEditTime: 2022-04-20 10:47:15
 */
...
export default interface CreatPublishDafaultPageModalViewModel {
  //表单提交成功事件
  formOnFinish(
    values: FormData,
  ...
  // 获取选中的素材数据
  getMaterialDataDefault(data: MaterialHistoryRecordEntity): void;
