 ...
 * @LastEditors: wuhao
 * @LastEditTime: 2022-04-21 14:38:20
 */
...
import CreatDafaultPageModalViewModel from './viewModel';
...
@observer
export default class CreatDafaultPageModal extends React.Component {
  private defaultModalViewModel = DI.DIContainer.get<CreatDafaultPageModalViewModel>(
  ...
  private defaultPageListViewModel = DI.DIContainer.get<DefaultPageListViewModel>(
  ...
  private configProvider = DI.DIContainer.get<ConfigProvider>(
  ...
  private historyUpload = async (): Promise<void> => {
    ...
    await getUploadRecordListData('platform');
    setUploadHistoryRecordModalVisible('default');
  };
    ...
    return (
      ...
      >
        <div className={style.exportModalContent}>
          ...
          <Form
            ref={this.adRef}
            onFinish={(values): void => formOnFinish(values, this.defaultPageListViewModel)}
            labelCol={{ span: 4 }}
            wrapperCol={{ span: 22 }}
          >
            <Form.Item
            ...
            <div className={style.bottomButton}>
              <Button onClick={(): void => setPublishDefaultModalVisible()}>取消</Button>
