...
module.exports = function (webpackEnv) {
    ...
    const loaders = [
      ...
      },
      {
        ...
        options: {
          ...cssOptions,
          // modules: {
          //   // override getLocalIdent, escape "ant-" define css
  ...
  return {
    ...
    output: {
      ...
      library: `tmis`,
      libraryTarget: 'umd',
      jsonpFunction: `webpackJsonp_tmis`,
    },
    optimization: {
...

        {
          ...
          oneOf: [
            ...
            // The preset includes JSX, Flow, TypeScript, and some ESnext features.
            {
              ...
              // exclude: [path.resolve('./node_modules/tinymce-i18n/')],
            ...
            // less loader for antdesign, change localIdentName
            {
              test: /global.less$/,
